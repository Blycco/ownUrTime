...
- [ ] lib/features/recovery/domain/entities/distraction.dart
  - freezed: id, sessionId, userId, type (DistractionType), occurredAt, returnedAt?
  - enum DistractionType { urgent, impulsive, rest }
- [ ] lib/features/recovery/domain/repositories/distraction_repository.dart
  - logDistraction(sessionId, type) → Future<Distraction>
  - markReturned(distractionId) → Future<void>
- [ ] lib/features/recovery/domain/usecases/log_distraction_usecase.dart
- [ ] lib/features/recovery/domain/usecases/recover_session_usecase.dart
...
## Data Layer (Codex)
- [ ] lib/features/recovery/data/models/distraction_model.dart
- [ ] lib/features/recovery/data/datasources/distraction_remote_datasource.dart
- [ ] lib/features/recovery/data/repositories/distraction_repository_impl.dart
...
- [ ] lib/features/recovery/presentation/widgets/context_restore_card.dart
...
## Tests (Codex)
- [ ] test/features/recovery/domain/log_distraction_usecase_test.dart
  - Test: logs distraction with correct type and sessionId
- [ ] test/features/recovery/domain/recover_session_usecase_test.dart
  - Test: returns task title and correct next step index
  - Test: marks distraction as returned with timestamp
- [ ] test/features/recovery/presentation/recovery_screen_test.dart
...
## Done When
- [ ] flutter analyze — zero warnings in features/recovery/
- [ ] All tests pass
- [ ] Each distraction type shows distinct, positive-framed message
- [ ] Context restore card shows correct task context
- [ ] Resume = 1 tap from context card
