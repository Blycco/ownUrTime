...
mixin _$Task {
 ...
 String get id; String get userId; String get title; List<String>? get decomposedSteps; TaskStatus get status; DateTime get createdAt; DateTime? get startedAt; DateTime? get completedAt;
...
@override
String toString() {
  return 'Task(id: $id, userId: $userId, title: $title, decomposedSteps: $decomposedSteps, status: $status, createdAt: $createdAt, startedAt: $startedAt, completedAt: $completedAt)';
}
...
@useResult
$Res call({
 String id, String userId, String title, List<String>? decomposedSteps, TaskStatus status, DateTime createdAt, DateTime? startedAt, DateTime? completedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String title,  List<String>? decomposedSteps,  TaskStatus status,  DateTime createdAt,  DateTime? startedAt,  DateTime? completedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Task() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String userId,  String title,  List<String>? decomposedSteps,  TaskStatus status,  DateTime createdAt,  DateTime? startedAt,  DateTime? completedAt)  $default,) {final _that = this;
switch (_that) {
case _Task():
return $default(_that.id,_that.userId,_that.title,_that.decomposedSteps,_that.status,_that.createdAt,_that.startedAt,_that.completedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String userId,  String title,  List<String>? decomposedSteps,  TaskStatus status,  DateTime createdAt,  DateTime? startedAt,  DateTime? completedAt)?  $default,) {final _that = this;
switch (_that) {
case _Task() when $default != null:
return $default(_that.id,_that.userId,_that.title,_that.decomposedSteps,_that.status,_that.createdAt,_that.startedAt,_that.completedAt);case _:
  return null;
...
class _Task implements Task {
  const _Task({required this.id, required this.userId, required this.title, final  List<String>? decomposedSteps, required this.status, required this.createdAt, this.startedAt, this.completedAt}): _decomposedSteps = decomposedSteps;
...
@override List<String>? get decomposedSteps {
